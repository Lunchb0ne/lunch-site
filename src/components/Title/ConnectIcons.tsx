...
const ConnectIcons: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <a target={'_blank'} href={'https://github.com/lunchb0ne'} rel="noreferrer">
        <Button
          as={motion.button}
          whileHover="hover"
          whileTap="tap"
      ...
      <a target={'_blank'} href={'https://www.linkedin.com/in/abhishekaryan16'} rel="noreferrer">
        <Button
          as={motion.button}
          rounded
          whileHover="hover"
